...
# React Native Radio Button Component
...
```jsx
<Radio label="Option A" initialValue />
```
...
| **selected**        | bool     | false       | Whether this radio is selected (controlled mode)                            |
...
| **initialValue**    | bool     | false       | Initial selection state (uncontrolled mode)                                 |
